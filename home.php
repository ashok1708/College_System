...
<body>
    <div class="main">
        <div class="header" style="display: flex">
            <h1 style="width: 90%; text-align: center">Rajathan Technical University, Kota</h1>
            <div class="form-group form-button">
                <a href="index.php" type="submit" name="signin" id="signin" class="form-submit" value="Back">Back</a>
            </div>
        </div>
